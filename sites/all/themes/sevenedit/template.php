 ...
 */
function sevenedit_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // sevenedit_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  sevenedit_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function sevenedit_preprocess_html(&$vars) {
 ...
 */
function sevenedit_preprocess_page(&$vars) {
 ...
 */
function sevenedit_node_add_list($variables) {
 ...
 */
function sevenedit_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function sevenedit_tablesort_indicator($variables) {
 ...
 */
function sevenedit_css_alter(&$css) {
